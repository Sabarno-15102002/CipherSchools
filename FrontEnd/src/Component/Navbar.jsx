...
export default function Navbar()
{
  ...
  const handleSubmitSignIn = (e) => {
    ...
    axios.post("https://localhost:5000", { email, password })
      .then((res) => {
        console.log(res);
  ...
  const handleSubmitSignUp = (e) => {
    e.preventDefault();
      axios.post("https://localhost:5000", { fname,lname, email, password, phone })
        .then((res) => {
          console.log(res);
        })
        .catch((err) => {
  ...
  <div className="loginPopup">
    <div className="formPopup" id="popupForm">
      ...
      <form action="/action_page.php" className="formContainer" style={{display:"none"}}>
        <h2>CipherSchools</h2>
